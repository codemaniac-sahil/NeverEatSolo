          ...
          <TabsContent value="spontaneous">
            <div className="mb-6 p-4 bg-primary/10 rounded-lg border border-primary/30">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-medium text-lg text-primary">Join Me Right Now</h3>
                  <p className="text-sm text-zinc-400">
                    Let nearby users know you're available for an immediate meal or coffee.
                    Perfect for spontaneous dining or unexpected free time.
                  </p>
                </div>
              </div>
            </div>
