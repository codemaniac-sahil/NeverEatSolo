...
// Create a new query client specifically for authentication
...
// Internal provider component that uses the query hooks
...
// External provider that wraps the internal one with its own QueryClientProvider
